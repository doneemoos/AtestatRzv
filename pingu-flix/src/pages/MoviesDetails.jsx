        ...
        <div className="bg-white rounded-xl shadow-lg flex flex-col md:flex-row p-6">
          ...
          <div className="md:ml-8 mt-6 md:mt-0 flex-1">
            ...
            <div className="flex items-center gap-2 mb-2">
              ...
              <span className="text-yellow-600 font-medium">IMDB: {movie.imdb || "N/A"}</span>
            </div>
            ...
            <div className="text-sm text-gray-600 space-y-1">
              ...
              <p><strong>Casts:</strong> {movie.cast || "N/A"}</p>
            </div>

            {/* Butoane Like/Dislike/Favorite */}
            <div className="flex items-center gap-4 mt-6">
              <button className="bg-blue-600 text-white px-4 py-1 rounded">👍 Like</button>
              <button className="bg-gray-300 text-gray-800 px-4 py-1 rounded">👎 Dislike</button>
