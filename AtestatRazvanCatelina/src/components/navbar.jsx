  ...
  return (
    <>
      ...
      <nav
        ...
        style={{
          backgroundImage: "linear-gradient(90deg,#0d0730 1%,#0f003f 100%)",
        }}
      >
        {/* Desktop */}
        <div className="hidden md:grid md:grid-cols-3 md:items-center">
          <div className="flex items-center">
            ...
            <Link
              ...
              onMouseEnter={() => play(videoRefDesktop)}
              onMouseLeave={() => reset(videoRefDesktop)}
            >
              PenguFlix
            </Link>
          </div>
          <div className="flex items-center justify-center">
            <ul className="flex gap-8 items-center">
              <li>
                <Link
                  className="text-white hover:underline navLink"
          ...
          <div className="flex items-center justify-end">
            <Link
              to="/Auth"
              className="inline-flex items-center justify-center px-4 py-2 text-white rounded-[0.8rem] shadow-md logInButton"
            >
              LOG IN
            </Link>
          </div>
        ...
        <div className="md:hidden flex flex-col items-center space-y-2">
          <div className="flex items-center justify-center">
            ...
            <Link
              ...
              style={{ fontFamily: "'Cinzel Decorative', serif" }}
              className="text-white text-3xl font-bold ml-2"
              onMouseEnter={() => play(videoRefMobile)}
              onMouseLeave={() => reset(videoRefMobile)}
            >
              PinguFlix
            </Link>
          </div>
          ...
          <div className="flex items-center">
            <Link
              to="/Auth"
              className="inline-flex items-center justify-center px-4 py-2 text-white rounded-[1rem] shadow-md logInButton"
            >
              Sign Up
            </Link>
          </div>
